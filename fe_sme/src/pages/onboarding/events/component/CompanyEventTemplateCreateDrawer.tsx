...
import type { CompanyEventTemplateCreateRequest } from "../company-event-template.types";

type Props = {
  open: boolean;
  loading: boolean;
  form: FormInstance<CompanyEventTemplateCreateRequest>;
  onClose: () => void;
  onSubmit: () => void;
};

export default function CompanyEventTemplateCreateDrawer({
  open,
  loading,
  form,
  onClose,
