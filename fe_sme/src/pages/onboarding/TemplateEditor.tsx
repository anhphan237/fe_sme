...
import { StepInfo } from "./template-editor/StepInfo";
import { StepStages } from "./template-editor/StepStages";
import { StepTasks } from "./template-editor/StepTasks";
import { StepReview } from "./template-editor/StepReview";
import { WizardFooter } from "./template-editor/WizardFooter";
import {
  type EditorForm,
  type ChecklistDraft,
  type TaskDraft,
