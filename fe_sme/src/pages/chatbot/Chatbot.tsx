...
function Chatbot() {
  ...
  const handleAsk = async (text?: string) => {
    ...
    setQuery('')
    if (!conversationTitle) setConversationTitle(question.slice(0, 40) + (question.length > 40 ? '…' : ''))
    ...
    try {
      ...
      const assistantMsg: Message = {
        ...
        role: 'assistant',
        content: result.answer || 'I couldn’t find a specific answer. Try rephrasing or ask your HR team.',
        ...
        <aside className="hidden w-56 shrink-0 lg:block">
          <Card className="flex h-full flex-col p-4">
            <div className="flex items-center justify-between gap-2">
              ...
              <Button variant="ghost" className="text-xs" onClick={handleNewChat}>
                New chat
              </Button>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {messages.length === 0 ? (
              <div className="flex h-full min-h-[280px] flex-col items-center justify-center text-center">
                ...
                <p className="text-sm font-medium text-ink">How can I help you today?</p>
                <p className="mt-1 text-sm text-muted">Ask about policies, first day, or benefits.</p>
