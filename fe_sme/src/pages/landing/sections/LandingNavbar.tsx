              ...
              <div className="relative w-9 h-9">
                ...
                <div className="relative flex items-center justify-center w-full h-full">
                  <svg viewBox="0 0 20 20" fill="none" className="w-4.5 h-4.5">
                    ...
                    <path d="M7 7h6M7 10.5h6M7 14h4" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                    <circle cx="15" cy="15" r="3.5" fill="white" />
                    <path d="M13.5 15l1 1 2-1.5" stroke="#6C63FF" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="flex flex-col leading-none">
                <span className={`text-[17px] font-bold tracking-tight transition-colors duration-300 ${scrolled ? "text-gray-900" : "text-white"}`}>
                  Onboard<span className="text-brand">IQ</span>
                </span>
                <span className={`text-[9px] font-semibold uppercase tracking-[0.2em] transition-colors duration-300 ${scrolled ? "text-gray-400" : "text-white/50"}`}>
                  SME Platform
                </span>
              </div>
            </a>
            ...
            <div ref={langRef} className="relative hidden md:block shrink-0">
              ...
              <div className={`absolute right-0 top-[calc(100%+8px)] w-44 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-50
                ...
                <div className="px-3 py-2 bg-gray-50 border-b border-gray-100">
                  <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Language</p>
                </div>
                {LANGUAGES.map((lang) => {
              ...
              return (
                <button
                  ...
                  <div className="flex-1">
                    <p className={`text-[14px] font-semibold ${isActive ? "text-brand" : "text-gray-800"}`}>
                      {lang.label}
                    </p>
                  </div>
                  {isActive && (
